...
2. Apache FileUpload Wrapper Class(Helper class) 
   - Apache FileUpload 콤포넌트를 사용하기 편리하도록 해주는 클래스 
   - request.getParameter() 기능을 지원 
...
[02] 파일 업로드 
     - 업로드시 한글이 깨질 경우의 처리 
        UploadSave.encode(upload.getParameter("title"));

1. 업로드 처리 모듈 사용(문자 파라메터만 가져옴)
>>>>> /WEBContent/ssi/ssi.jsp
<%@ page contentType="text/html; charset=UTF-8" %> 
