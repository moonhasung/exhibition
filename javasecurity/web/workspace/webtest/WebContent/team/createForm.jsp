...
<tr>
	<th>우편번호</th>
	<td>
	<input type="text" name="zipcode" size="8" maxlength="5" id="sample6_postcode" placeholder="우편번호">
...
<tr>
	<th>주소</th>
	<td>
		<input type="text" name="address1" size="45" id="sample6_address" placeholder="주소"><br>
...
<tr>
	...
	<td>
		...
		<label><input type="checkbox" name="skills" value="jsp">jsp</label>
		<label><input type="checkbox" name="skills" value="MVC">MVC</label>
