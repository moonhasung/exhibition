...
public class MemoDAO {
    ...
    try {
		...
		pstmt.setInt(3, dto.getGrpno());//부모의 grpno
		pstmt.setInt(4, dto.getIndent()+1);//부모의 indent+1
		pstmt.setInt(5, dto.getAnsnum()+1);//부모의 ansnum+1
		pstmt.setInt(6, dto.getMemono());//부모의 memono
